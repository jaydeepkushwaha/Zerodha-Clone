...
import { useNavigate } from "react-router-dom";
    ...
    const goToLogin = () => {
        navigate("/signup");  // ✅ yaha redirect ho jayega
    };
        return (
            <div className="container">
                ...
                <div className="text-center " style={{ padding: "50px 50px 100px 50px" }}>
                    <a  onClick={goToLogin} className='btn btn-primary fs-5 fw-bold w-25 p-3 mt-4  ' style={{ margin: "0 auto" }}>Sign up for free</a>
                </div>
            </div>
        )
    }
