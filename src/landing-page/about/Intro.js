...
function Intro() {
    return (
        <div className="container p-5">
            <div className="row">
                <div className="col-6 AboutC">
                    <p className="AboutD">We kick-started operations on the 15th of August, 2010 with the goal
                ...
                <div className="col-6 AboutE">
                    <p  className="AboutD">In addition, we run a number of popular open online educational
                    ...
                    <p  className="AboutD">
                        ...
                        latest updates on our <a href="#">blog</a> or see what the media is <a href="#">saying
                        about us</a> or learn more about our business and product <a href="#">philosophies</a>.
                    </p>
                </div>
            </div>
